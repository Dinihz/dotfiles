...
vim.o.mouse = "" -- Enables mouse support in all modes (default: '')
...
vim.opt.colorcolumn = "100" -- Set the colorcolumn at 100 characteres
-- Disable the default tabline to avoid the extra top bar showing full file paths.
-- This happens when no bufferline/tabline plugin is managing that UI space.
vim.o.showtabline = 0
